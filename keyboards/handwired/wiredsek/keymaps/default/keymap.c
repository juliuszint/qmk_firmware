...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT( \
        KC_ESC, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6,    KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_PSCR, KC_DEL,    KC_SLCK, KC_PAUS, KC_NLCK,    KC_CALC, KC_MYCM, KC_MAIL, KC_LOCK, \
        ...
        KC_CLCK, KC_A, KC_S, KC_D, KC_F, KC_G,               KC_H, KC_J, KC_K, KC_L, DE_ODIA, DE_ADIA, DE_HASH,                                             KC_P4, KC_P5, KC_P6, \
        KC_LSFT, DE_LABK, KC_Y, KC_X, KC_C, KC_V, KC_B,      KC_N, KC_M, DE_COMM, DE_DOT, DE_MINS, KC_RSFT,                   KC_UP,                        KC_P1, KC_P2, KC_P3, KC_PENT, \
        KC_LCTL, KC_LCTL, KC_LGUI, KC_LALT, KC_SPC,          KC_RALT, KC_RGUI, KC_APP, KC_RCTL,                               KC_LEFT, KC_DOWN, KC_RIGHT,   KC_P0, KC_PDOT \
  )
};
