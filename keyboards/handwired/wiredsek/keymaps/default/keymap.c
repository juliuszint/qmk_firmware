...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT( \
        ...
        KC_LCAP, KC_A, KC_S, KC_D, KC_F, KC_G,               KC_H, KC_J, KC_K, KC_L, OSL(3), DE_ADIA, DE_HASH,                                              KC_P4, KC_P5, KC_P6, \
        KC_LSFT, DE_LABK, DE_Y, KC_X, KC_C, KC_V, KC_B,      KC_N, KC_M, DE_COMM, DE_DOT, MT(MOD_RCTL, DE_MINS), KC_RSFT,              KC_UP,               KC_P1, KC_P2, KC_P3, KC_PENT, \
        KC_LCTL, OSL(1), KC_LGUI, OSL(2), KC_SPC,            OSL(2), KC_RGUI, KC_APP, KC_RCTL,                                KC_LEFT, KC_DOWN, KC_RIGHT,   KC_P0, KC_PDOT \
  ),
  [1] = LAYOUT( \
  ...
  [3] = LAYOUT( \
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                       KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,             KC_TRNS, KC_TRNS, KC_TRNS,   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, \
        KC_TRNS, ST_MACRO_0, ST_MACRO_1, ST_MACRO_2, ST_MACRO_3, ST_MACRO_4, ST_MACRO_5,     ST_MACRO_6, ST_MACRO_6, ST_MACRO_8, ST_MACRO_9, KC_TRNS, KC_TRNS, KC_TRNS,          KC_TRNS, KC_TRNS, KC_TRNS,   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, \
        RALT(KC_TAB), KC_TRNS, KC_TRNS, KC_TRNS, ST_MACRO_13, KC_TRNS,                       KC_TRNS, KC_TRNS, KC_TRNS, KC_UP, LSFT(KC_INSERT), KC_TRNS, KC_TRNS, KC_TRNS,       KC_TRNS, KC_TRNS,            KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, \
        KC_TRNS, ST_MACRO_14, ST_MACRO_10, ST_MACRO_11, ST_MACRO_12, KC_TRNS,                KC_TRNS, KC_LEFT, KC_DOWN, KC_RIGHT, KC_TRNS, KC_TRNS, KC_TRNS,                                                  KC_TRNS, KC_TRNS, KC_TRNS, \
        KC_TRNS, KC_TRNS, KC_TRNS, ST_MACRO_15, ST_MACRO_16, KC_TRNS, KC_TRNS,               KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                                        KC_TRNS,            KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, \
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                                         KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                                                 KC_TRNS, KC_TRNS, KC_TRNS,   KC_TRNS, KC_TRNS \
  ),
};
